...
let favFoods = ['pizza', 'tacos', 'steak', 'cheese']
...
//Tried two different versions here, both of which I believe work but the prior i'd guess is better since it's more concise.
...
console.log(`Added a new food to beginning: ${favFoods}`);
...
//     log both the food removed and the updated array
let removedFood2 = favFoods.shift();
console.log('Removed the first favorite food', removedFood2)
console.log('The favorite foods are now', favFoods);
